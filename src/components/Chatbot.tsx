    ...
    <>
      ...
      <AnimatePresence>
        {isOpen && (
          ...
          >
            {/* Header */}
            <div className="bg-yellow-600 text-black p-4 rounded-t-lg flex items-center justify-between">
            ...
            <div className="p-4 border-t border-gray-200">
              <div className="flex space-x-2">
                ...
                <button
                 ...
                 className="bg-yellow-600 text-black p-2 rounded-md hover:bg-yellow-500 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                >
                 {loading ? (
